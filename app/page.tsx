    ...
    <>
      <main className={styles.home + " p-5 text-[#333]"}>
        <header className='header-greeting'>
          ...
          <div className={clsx([styles.whoiam, 'whoiam'])}>
        ...
        <nav className={styles['nav-links']}>
          <a href="https://blog.junxio.cc" aria-label='blog' target="_blank">
            <svg strokeLinejoin="round" viewBox="0 0 16 16" width="12" height="12" style={{ color: '#666' }}><path fillRule="evenodd" clipRule="evenodd" d="M8.75 0.189331L9.28033 0.719661L15.2803 6.71966L15.8107 7.24999L15.2803 7.78032L13.7374 9.32322C13.1911 9.8696 12.3733 9.97916 11.718 9.65188L9.54863 13.5568C8.71088 15.0648 7.12143 16 5.39639 16H0.75H0V15.25V10.6036C0 8.87856 0.935237 7.28911 2.4432 6.45136L6.34811 4.28196C6.02084 3.62674 6.13039 2.80894 6.67678 2.26255L8.21967 0.719661L8.75 0.189331ZM7.3697 5.43035L10.5696 8.63029L8.2374 12.8283C7.6642 13.8601 6.57668 14.5 5.39639 14.5H2.56066L5.53033 11.5303L4.46967 10.4697L1.5 13.4393V10.6036C1.5 9.42331 2.1399 8.33579 3.17166 7.76259L7.3697 5.43035ZM12.6768 8.26256C12.5791 8.36019 12.4209 8.36019 12.3232 8.26255L12.0303 7.96966L8.03033 3.96966L7.73744 3.67677C7.63981 3.57914 7.63981 3.42085 7.73744 3.32321L8.75 2.31065L13.6893 7.24999L12.6768 8.26256Z" fill="currentColor"></path></svg>
            Blog
          </a>
          <a href="https://github.com/jxzho" aria-label='github' target="_blank">
            <svg strokeLinejoin="round" viewBox="0 0 16 16" width="12" height="12" style={{ color: '#666' }}><g clipPath="url(#clip0_872_3147)">
          ...
          <a className='block' aria-label='twitter' href="https://twitter.com/Rjunxio" target="_blank">
            <svg strokeLinejoin="round" viewBox="0 0 16 16" width="12" height="12" style={{ color: '#666' }}><path fillRule="evenodd" clipRule="evenodd" d="M0.5 0.5H5.75L9.48421 5.71053L14 0.5H16L10.3895 6.97368L16.5 15.5H11.25L7.51579 10.2895L3 15.5H1L6.61053 9.02632L0.5 0.5ZM12.0204 14L3.42043 2H4.97957L13.5796 14H12.0204Z" fill="currentColor"></path></svg>
            Twitter
          </a>
          <a href="https://www.zhihu.com/people/xioxio96" aria-label='zhihu' target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 32 32" style={{ color: '#333' }}>
        ...
        <nav className={styles['nav-links-inner']}>
          <ul>
            <li>
              <Link href={'/projects'}>
                Projects
                <svg strokeLinejoin="round" viewBox="0 0 16 16" width="12" height="12" style={{ color: '#666' }}><path fillRule="evenodd" clipRule="evenodd" d="M6.75011 4H6.00011V5.5H6.75011H9.43945L5.46978 9.46967L4.93945 10L6.00011 11.0607L6.53044 10.5303L10.499 6.56182V9.25V10H11.999V9.25V5C11.999 4.44772 11.5512 4 10.999 4H6.75011Z" fill="currentColor"></path></svg>
              </Link>
            </li>
