    ...
    <>
      <main className={styles.home + " p-5 text-[#333]"}>
        ...
        <nav className={styles['nav-links']}>
          <a href="https://blog.junxio.cc" target="_blank">
          ...
          <a className='block' href="https://twitter.com/Rjunxio" target="_blank">
          ...
          <a href="https://www.zhihu.com/people/xioxio96" target="_blank">
